...
public class EnviarMensajeCanalPushActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enviarmensajecanalpush);
    ...
    private SharedPreferences getGcmPreferences(Context context) {
        return getSharedPreferences(EnviarMensajeCanalPushActivity.class.getSimpleName(),
