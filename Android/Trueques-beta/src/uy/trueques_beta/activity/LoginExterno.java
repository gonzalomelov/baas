 ...
 * well.
 */
public class LoginExterno extends Activity {
	/**
...
//		getMenuInflater().inflate(R.menu.login, menu);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			if(Factory.getUsuarioCtrl().login(LoginExterno.this, mEmail, mPassword)){
				u = null;
				while (u==null)
					u= Factory.getUsuarioCtrl().getUsuario(LoginExterno.this, mEmail);
				return true;
			}else{
				return false;
			}
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				Intent intent;
				intent = new Intent(LoginExterno.this, Home.class);
//					Usuario u = null;
//					while (u==null)
//						u= Factory.getUsuarioCtrl().getUsuario(Login.this, mEmail);
				...
				editor.putBoolean("externo", true);
				editor.commit();
