...
public class ApplicationServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://baas-gonzalomelov.rhcloud.com/baas-core/ApplicationServices?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ApplicationServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://baas-gonzalomelov.rhcloud.com/baas-core/ApplicationServices?wsdl");
        }
        WSDL_LOCATION = url;
    }
