...
public class PermissionServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/baas-core/PermissionServices?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PermissionServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/baas-core/PermissionServices?wsdl");
        }
        WSDL_LOCATION = url;
    }
