...
public interface ApplicationServices {
    ...
    public long createApplication(
        ...
        @WebParam(name = "entidadSync", targetNamespace = "")
        java.util.List<java.lang.Boolean> entidadSync
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "GetRoleName", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetRoleName")
    @WebMethod(operationName = "GetRoleName")
    @ResponseWrapper(localName = "GetRoleNameResponse", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetRoleNameResponse")
    public java.lang.String getRoleName(
        @WebParam(name = "arg0", targetNamespace = "")
        long arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        long arg1
    ) throws RoleNotFoundException_Exception, AppNotRegisteredException_Exception;
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "GetEntityName", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetEntityName")
    @WebMethod(operationName = "GetEntityName")
    @ResponseWrapper(localName = "GetEntityNameResponse", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetEntityNameResponse")
    ...
    public uy.com.group05.baascore.sl.services.soap.ChartDto getChartsValues(
        @WebParam(name = "idApp", targetNamespace = "")
        long idApp,
        @WebParam(name = "tipoChart", targetNamespace = "")
        uy.com.group05.baascore.sl.services.soap.TipoChart tipoChart
    ) throws AppNotRegisteredException_Exception;

    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "getPermissionsForRol", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetPermissionsForRol")
    @WebMethod
    @ResponseWrapper(localName = "getPermissionsForRolResponse", targetNamespace = "http://soap.services.sl.baascore.group05.com.uy/", className = "uy.com.group05.baascore.sl.services.soap.GetPermissionsForRolResponse")
    public java.util.List<uy.com.group05.baascore.sl.services.soap.PermissionDTO> getPermissionsForRol(
        @WebParam(name = "appId", targetNamespace = "")
        long appId,
