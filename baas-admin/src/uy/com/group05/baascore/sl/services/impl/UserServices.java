...
public class UserServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/baas-core/UserServices?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/baas-core/UserServices?wsdl");
        }
        WSDL_LOCATION = url;
    }
     ...
     *
     * @return
     *     returns UserSoapFacade
     */
    @WebEndpoint(name = "UserServicesPort")
    public UserSoapFacade getUserServicesPort() {
        return super.getPort(UserServicesPort, UserSoapFacade.class);
    }
     ...
     */
    @WebEndpoint(name = "UserServicesPort")
    public UserSoapFacade getUserServicesPort(WebServiceFeature... features) {
        return super.getPort(UserServicesPort, UserSoapFacade.class, features);
    }
